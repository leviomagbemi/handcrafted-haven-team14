...
import { UserCircleIcon, ShoppingCartIcon, CheckBadgeIcon } from "@heroicons/react/24/outline";
						...
						{isLoggedIn && user ? (
							<div className="flex items-center gap-3">
								<Link href="/dashboard/account" aria-label="Account" className="flex items-center gap-2 group">
									...
									{user.role === 'artisan' && (
										<CheckBadgeIcon className="h-4 w-4 text-primary hidden sm:block" aria-label="Verified Artisan" />
									)}
								</Link>
								<button 
